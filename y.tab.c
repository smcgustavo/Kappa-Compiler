...
{
       0,    89,    89,    96,   101,   107,   112,   117,   122,   129,
     136,   161,   181,   194,   200,   206,   212,   218,   222,   227
};
#endif
...
static const char *const yytname[] =
{
  ...
  "TK_FIM", "TK_ERROR", "'='", "'!'", "'|'", "'&'", "'<'", "'>'", "'+'",
  "'-'", "'*'", "'/'", "'('", "')'", "'{'", "'}'", "';'", "$accept", "S",
  "BLOCO", "COMANDOS", "COMANDO", "ATRIBUICAO", "E", YY_NULLPTR
};
#endif
...
{
      -4,     3,     8,   -21,   -41,   -20,   -10,    -3,   -41,   -22,
       4,    30,   -41,    -7,    -3,    -5,   -30,   -41,    -6,     9,
     -41,   -41,   -41,    -6,    -6,    -6,    -6,   -41,    -8,     5,
       7,    10,    11,   -40,   -40,   -41,   -41,    -6,    -6,    -6,
      -6,    -8,    -8,    -8,    -8
};
...
{
       0,     0,     0,     0,     1,     0,     0,     5,     2,     0,
      19,     0,    18,     0,     5,     0,     0,     8,     0,     0,
       3,     4,     7,     0,     0,     0,     0,     6,    17,     0,
...
{
       9,    10,    25,    26,    10,    11,     1,     3,     4,    28,
      23,    24,    25,    26,    33,    34,    35,    36,    27,    29,
      30,    31,    32,     5,    12,     6,    17,    12,    41,    42,
      43,    44,    23,    24,    25,    26,     7,    19,    18,    37,
      20,    38,    21,    22,    39,    40
};

static const yytype_int8 yycheck[] =
{
       3,     7,    42,    43,     7,     8,    10,     4,     0,    18,
      40,    41,    42,    43,    23,    24,    25,    26,    48,    10,
      11,    12,    13,    44,    30,    45,    48,    30,    37,    38,
      39,    40,    40,    41,    42,    43,    46,     7,    34,    34,
      47,    34,    14,    48,    34,    34
};
...
static const yytype_int8 yystos[] =
{
       ...
       7,     8,    30,    52,    53,    54,    55,    48,    34,     7,
      47,    52,    48,    40,    41,    42,    43,    48,    55,    10,
      11,    12,    13,    55,    55,    55,    55,    34,    34,    34,
      34,    55,    55,    55,    55
};
